...
import { GET_VARIABLES_QUERY_KEY } from "@/app/(with-logged-in-user)/variables/queries";
import {
...
export default function VariablesPage() {
  ...
  const {
    ...
    queryKey: ["variables", debouncedSearchQuery],
    queryFn: async ({
      pageParam,
    }: {
  ...
  const addVariableMutation = useMutation({
    ...
    onSettled: () =>
      queryClient.invalidateQueries({ queryKey: GET_VARIABLES_QUERY_KEY }),
  });
